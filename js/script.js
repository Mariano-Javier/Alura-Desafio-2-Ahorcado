...
document.addEventListener("keydown", (event) => {
    ...
    if (nombre.match(/^([a-z|ñ|]{1,})$/)) {//[a-z] limite de valores, {1,} indica el largo de caracteres, en este caso solo buscamos 1, ya que hay teclas q comienzan con caracteres validos.
      ...
      if (idx == -1) {
        ...
        if (letrasRechazadasTemp.includes(element) && contadorLetras(letrasRechazadasTemp,element)==1 ){//verifica que no se escriban letras repetidas en pantalla
